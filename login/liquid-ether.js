  ...
  init: function(container, options) {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        this.resize();
        this.renderer = new THREE.WebGLRenderer({ antialias: true, alpha: false }); // alpha false for solid bg
        this.renderer.autoClear = false;
        this.renderer.setClearColor(new THREE.Color(0x000000), 1); // solid black
        ...
        super({
          material: {
            ...
            uniforms: {
              ...
              velocity: { value: simProps.src.texture },
              velocity_new: { value: simProps.src.texture },
      ...
      constructor(simProps) {
        super({
          material: {
            ...
            uniforms: {
              boundarySpace: { value: simProps.boundarySpace },
              pressure: { value: (simProps.src_p ? simProps.src_p : simProps.src).texture },
      ...
      init() {
        ...
        this.output = new THREE.Mesh(
          ...
          new THREE.RawShaderMaterial({
            ...
            transparent: false, // for solid bg
            depthWrite: false,
            uniforms: {
