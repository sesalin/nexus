...
interface IconProps {
  ...
  // For SVG icons  
  svgIcon?: 'energy' | 'security' | 'voice' | 'gadgets' | 'zones';
...
export const Icon: React.FC<IconProps> = ({ 
  ...
  const getSvgSource = () => {
    switch (svgIcon) {
      ...
      case 'zones': return '../assets/icons/Smart-plug.svg'; // Will be updated with proper zones icon
      default: return null;
    }
  };
  ...
  if (svgName) {
    ...
    return (
      <div 
        ...
        `}
        style={{
          backgroundImage: `url(${dynamicSvgSource})`,
