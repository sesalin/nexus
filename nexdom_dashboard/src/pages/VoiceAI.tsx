...
export const VoiceAI: React.FC = () => {
  ...
  return (
    <div className="flex-1 min-h-full relative">
      ...
      <div className="max-w-[1600px] mx-auto py-6 px-4 lg:px-8 lg:pl-32 relative z-10 h-[calc(100vh-100px)] flex flex-col">
          ...
          <div className="flex-1 p-8 overflow-y-auto space-y-6 relative z-10">
            {messages.map((msg, idx) => (
              <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[80%] p-5 rounded-2xl backdrop-blur-md border ${
                  msg.role === 'user' 
