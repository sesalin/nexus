          ...
          {scenes.map((scene) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute -right-10 -top-10 w-40 h-40 rounded-full blur-[60px] transition-colors duration-500 ${
                  scene.isActive ? 'bg-nexdom-lime/20' : 'bg-white/5 group-hover:bg-white/10'
                }`}></div>
                
                <div className="relative z-10">
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 transition-colors ${
                    scene.isActive ? 'bg-nexdom-lime text-black' : 'bg-white/10 text-white'
                  }`}>
                  ...
                  <button className={`w-full py-3 rounded-xl flex items-center justify-center gap-2 text-sm font-bold transition-all ${
                    scene.isActive 
