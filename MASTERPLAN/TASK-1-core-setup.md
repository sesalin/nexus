...
**Agent**: AI-1  
**Priority**: 🔴 CRITICAL - BLOQUEA TODO  
**Duration**: 6-8 horas  
**Dependencies**: None
...
Configurar @hakit/core, eliminar backend Node.js, establecer conexión WebSocket con Home Assistant.
...
- [ ] Test conexión WebSocket directa a HAOS
...
**Estado actual**: OAuth2 funcionando, pero sin conexión HA.
...
**Explicación**:
- `HassConnect` maneja toda la conexión WebSocket
- Detecta automáticamente si usa access_token de OAuth
...
2. ✅ Browser console muestra: `[HassConnect] Connected`
3. ✅ WebSocket a HAOS establecido (Network tab)
4. ✅ `useHass()` retorna entities
5. ✅ `useAreas()` retorna áreas de tu HAOS

### Should Have
6. ✅ No console errors
7. ✅ OAuth2 flow mantiene funcionando
8. ✅ Logout funciona

### Nice to Have
9. ✅ TypeScript sin errores
10. ✅ Build production funciona
...
// Reload page
// Deberías ver logs de @hakit/core
```
...
- Check: OAuth token válido
- Check: CORS configurado en HA
- Check: Network tab para ver requests

### Error: "useHass must be used within HassConnect"
- Verifica que Dashboard esté dentro de `<HassConnect>`
- Orden correcto: Router → ProtectedRoute → HassConnect → Dashboard

### Error: "Entities empty"
- Espera 2-3 segundos (conexión WebSocket toma tiempo)
- Check console logs
...
1. ✅ **Branch**: `feature/hakit-core-setup`
2. ✅ **Commits**:
...
3. ✅ **Screenshot**: Dashboard mostrando áreas de HAOS
4. ✅ **Video** (opcional): WebSocket conectando en DevTools
