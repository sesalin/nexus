 ...
 * @returns
 */
export declare const timeCachePromiseFunc: <T>(cacheKey: string, cacheTime: number, func: (connection: Connection) => Promise<T>, generateCacheKey: ((hassEntities: HassEntities, lastResult: T) => unknown) | undefined, connection: Connection, hassEntities: HassEntities) => Promise<T>;
//# sourceMappingURL=timeCacheFunctionPromise.d.ts.map