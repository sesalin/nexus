...
`,c=E.createStyled("img",process.env.NODE_ENV==="production"?{target:"e1vxbsg90"}:{target:"e1vxbsg90",label:"StyledVacuumImage"})("width:80%;image-rendering:crisp-edges;cursor:pointer;filter:brightness(0.9);transition:opacity var(--ha-transition-duration) var(--ha-easing);&.on,&.cleaning,&.mowing,&.edgecut,&.auto,&.spot,&.edge,&.single_room{animation:",h," 5s linear infinite;}&.returning{animation:",i," 2s linear infinite;}&.paused{opacity:100%;}&.docked{opacity:0.5;}");function n({src:R=o,...I}){return a.jsx(c,{src:R,...I})}exports.StyledVacuumImage=c;exports.VacuumImage=n;
//# sourceMappingURL=VacuumImage.js.map
